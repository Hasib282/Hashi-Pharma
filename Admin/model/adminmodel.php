...
function Login($data){
    $conn = db_conn();
    $sql="select * from admin where (username = :id or email = :id) and pass = :pass";
    try{
        $stmt = $conn->prepare($sql);
        $stmt->execute([
            ':id' => $data['id'],
...
function updateAdminProfile($id, $data){
    $conn = db_conn();
    $sql = "CALL UPDATEADMIN(:Username,:Name,:Email,:Id)";
    try{
        $stmt = $conn->prepare($sql);
        $stmt->execute([
         ':Username' => $data['uname'], 
...
function updateAdminPass($id, $data){
    $conn = db_conn();
    $sql = "CALL UPDATEADMINPASS(:Id,:Pass) ";
    try{
        $stmt = $conn->prepare($sql);
        $stmt->execute([
            ':Pass' => $data['Password'],
...
function changeStatus($data){
    $conn = db_conn();
    $sql = "CALL UPDATEADMINSTATUS(:Id, :Status)";
    try{
        $stmt = $conn->prepare($sql);
        $stmt->execute([
            ':Status' => $data['status'],
...
function updateProduct($id, $data){
    $conn = db_conn();
    $sql = "CALL UPDATEPRODUCT(:ID, :stock, :price) ";
    try{
        $stmt = $conn->prepare($sql);
        $stmt->execute([
         ':price' => $data['price'], 

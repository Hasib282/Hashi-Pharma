...
function Login($data){
    $conn = db_conn();
    $sql="select * from customer where (username = :id or email = :id) and Password = :pass";
    try{
        $stmt = $conn->prepare($sql);
        $stmt->execute([
            ':id' => $data['id'],
...
function updateCustomerProfile($id, $data){
    $conn = db_conn();
    $sql = "CALL UPDATECUSTOMERPROFILE(:Id,:Name,:Phone,:Gender,:Address)";
    try{
        $stmt = $conn->prepare($sql);
        $stmt->execute([
         ':Name' => $data['name'], 
...
function updateCustomerPass($id, $data){
    $conn = db_conn();
    $sql = "CALL UPDATECUSTOMERPASS(:Id, :Pass) ";
    try{
        $stmt = $conn->prepare($sql);
        $stmt->execute([
            ':Pass' => $data['Password'],
...
function updateCustomerProfilepic($id, $data){
    $conn = db_conn();
    $sql = "CALL UPDATECUSTOMERPROFILEPIC(:Id, :profile)";
    try{
        $stmt = $conn->prepare($sql);
        $stmt->execute([
...
function addCart($data){
    ...
    VALUES (:Cid,  :Pid, :Quantity, SYSTIMESTAMP)";
...
function updateCart($pid,$cid, $data){
    $conn = db_conn();
    $sql = "CALL UPDATECARTQUANTITY(:cid, :pid, :quantity)  ";
    try{
        $stmt = $conn->prepare($sql);
        $stmt->execute([
            ':cid' => $cid,
...
function updateOrders($data){
    $conn = db_conn();
    $sql = "CALL UPDATEORDERSTATUS(:id, :status)  ";
    try{
        $stmt = $conn->prepare($sql);
        $stmt->execute([
            ':id' => $data['id'],
